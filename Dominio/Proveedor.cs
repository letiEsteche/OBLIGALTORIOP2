...
namespace Dominio
{
    public class Proveedor
    {
        ...
        {
            if (!(this.telefonoProveedor != null))
            {
        ...
        {
            if (!(this.direccionProveedor != null))
            {
        ...
        {
            return $"Proveedor con nombre {this.nombreProveedor}, telefono {this.telefonoProveedor}, direccion {this.direccionProveedor} y descuento {this.descuentoParaTodaActividadTercearizada}";
        }
